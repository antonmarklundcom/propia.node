...
- P2 — hub hero photos: `docs/log/p2.md`. The WebPs were committed later, then deleted with the hub hero itself (#176 compact header, #185 removed the files, 2026-09-22). Nothing left to do.
