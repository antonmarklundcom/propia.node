...
export const esPublicUi = {
  tagline: "Encontrá tu propiedad en Paraguay",
  description: "Casas, departamentos y terrenos en venta y alquiler en todo Paraguay.",
  home: "Inicio",
...
export const esPanel = {
  ...
  leadsSamePhone: (n: number) => `${n} consultas de este número`,
  leadsSamePhoneFilter: "Mostrando todas las consultas del mismo número de WhatsApp.",
  leadsSamePhoneClear: "Ver todas",
  readyTitle: "Listo para socio",
  readyMissing: "Falta:",
  readyAll: "Todo listo",
  readyNotVerified: "verificar",
  readyNoWhatsapp: "WhatsApp",
  readyNoLogin: "una cuenta con acceso",
  readyNoLogo: "logo",
  readyNoBio: "bio de un agente",
  readyNoListing: "un aviso publicado",
  shareTitle: "Compartir con un socio",
  shareTargetLabel: "Socio",
  shareTargetPlaceholder: "Elegí inmobiliaria o agente",
  shareNoteLabel: "Nota para el socio (opcional)",
  shareSubmit: "Compartir",
  shareBulkTitle: "Compartir las seleccionadas",
  shareBulkSubmit: "Compartir seleccionadas",
  shareSelect: "Seleccionar",
  shareHint:
    "El socio ve la consulta en su panel (Consultas) con tu nota. Compartí solo con quien la persona aceptó que la contacte.",
  shareNoTargets:
    "Todavía no hay inmobiliarias ni agentes verificados. Verificalos en Inmobiliarias para poder compartir.",
  shareNotify: "Avisar por WhatsApp",
  shareNotifyMessage: (params: { name: string | null; panelUrl: string }) =>
    `Hola, te compartí una consulta${params.name ? ` de ${params.name}` : ""} en tu panel: ${params.panelUrl}`,
  shareRevoke: "Quitar acceso",
  shareRevokedLabel: "Acceso quitado",
  shareStateLabel: {
  ...
  shareFlashShared: "Consulta compartida. Avisale al socio por WhatsApp.",
  shareFlashNone:
  ...
  sharedLeadsHint:
    "El equipo del portal te pasó estas consultas. Contestale a la persona y marcá qué pasó: el portal lo ve.",
  sharedLeadNoteFrom: "Nota del portal:",
  sharedLeadSaved: "Guardado. El portal ya ve tu respuesta.",
  sharedLeadInvalid: "No se pudo guardar: la consulta ya no está compartida con vos.",
  shareStateAction: {
    accepted: "La tomo",
    declined: "No puedo",
...
export const esGuideEn = {
  ...
  footerTagline:
    "Un portal guía-primero para comprar una propiedad en Paraguay desde el exterior: avisos con su moneda a la vista y el proceso de escritura pública explicado paso a paso.",
  ...
  heroTitleAccent: "A tu nombre",
  heroTitleTail: ", desde el exterior.",
  heroStrap:
    "Los extranjeros pueden comprar y ser dueños de una propiedad en Paraguay a su nombre. Un escribano formaliza la transferencia por escritura pública. Cada aviso muestra su precio en la moneda que eligió quien publica: dólares o guaraníes.",
  heroGuideLink: "O empezá por la guía: Cómo funciona la compra →",
  factsStrip: [
    { numeral: "A tu nombre", label: "Los extranjeros pueden comprar y ser dueños" },
    { numeral: "US$ / Gs", label: "Cada precio muestra su moneda" },
    { numeral: "Por escrito", label: "Pedí el detalle completo de costos antes de firmar" },
    { numeral: "Escritura pública", label: "Formalizada por un escribano" },
  ],
  ...
  whyCards: [
    {
      title: "Propiedad",
      text: "Los extranjeros pueden comprar y ser dueños a su nombre. Preguntá al escribano si el terreno concreto tiene alguna regla adicional antes de comprometerte.",
      href: "/guias/buying-property-in-paraguay",
    },
    {
      title: "Costo de vida e impuestos",
      text: "Lo que pagás depende de la propiedad y de tu situación. Leé la guía y confirmalo con un contador o con el escribano.",
      href: "/guias/costs-and-taxes-buying-in-paraguay",
    },
    {
      title: "Residencia",
      text: "La residencia es un trámite aparte de la compra. Leé la guía y confirmá los requisitos vigentes con Migraciones.",
  ...
  howSteps: [
    ...
    { title: "Oferta y reserva", text: "Se acuerda un precio y se firma una reserva.", who: "Comprador y vendedor", time: "Se acuerda con el vendedor" },
    { title: "Diligencia sobre el título", text: "Verificación en el Registro Público.", who: "Escribano", time: "Consultá al escribano" },
    { title: "Escritura pública", text: "Firma ante escribano.", who: "Escribano", time: "Lo fija el escribano" },
    { title: "Inscripción y entrega", text: "Inscripción registral y entrega de llaves.", who: "Escribano", time: "Consultá al escribano" },
  ],
  costsTableTitle: "Costos de la compra",
  costsTableHead: ["Concepto", "Quién paga", "Cómo obtener el monto"],
  costsRows: [
    { item: "Impuestos de transferencia", who: "Confirmalo con el escribano", typical: "En el detalle escrito del escribano" },
    { item: "Honorarios del escribano", who: "Confirmalo con el escribano", typical: "Pedí un presupuesto por escrito" },
    { item: "Inscripción registral", who: "Confirmalo con el escribano", typical: "En el detalle escrito del escribano" },
    { item: "Comisión de la inmobiliaria", who: "Acordala por escrito", typical: "Preguntá al agente antes de visitar" },
  ],
  relocationTitle: "Mudarse a Paraguay",
  relocationCards: [
    { title: "Mudanza", text: "Las reglas de ingreso y residencia cambian. Leé la guía y confirmalas con Migraciones.", href: "/guias/residency-in-paraguay" },
    { title: "Bancos", text: "Preguntá al banco qué documentos pide a un extranjero antes de viajar.", href: "/guias/costs-and-taxes-buying-in-paraguay" },
    { title: "Colegios", text: "Opciones bilingües en Asunción y alrededores.", href: "/guias/residency-in-paraguay" },
    { title: "Salud", text: "Compará planes de salud privados antes de mudarte.", href: "/guias/residency-in-paraguay" },
  ],
  faqTitle: "Preguntas frecuentes",
  faqSubtitle: (brand: string) => `Lo que necesitás saber antes de comprar en ${brand}.`,
  faq: [
    { q: "¿Pueden los extranjeros ser dueños de tierras en Paraguay?", a: "Los extranjeros pueden comprar y ser dueños a su nombre. Preguntá al escribano si el terreno concreto tiene alguna regla adicional." },
    { q: "¿Necesito estar presente en persona?", a: "Consultá al escribano. Un poder es una forma de que otra persona firme por vos; el escribano te dice qué debe contener." },
    { q: "¿Cómo envío el dinero?", a: "Acordá la forma de pago con el escribano antes de firmar, y nunca envíes dinero a una cuenta que no confirmaste directamente con él." },
    { q: "¿Qué es una cédula?", a: "El documento de identidad paraguayo. Preguntá al escribano si tu compra lo necesita o si alcanza con el pasaporte." },
  ],
  cardPerM2: (v: string) => `${v}/m²`,
  ...
  foreignerBoxOwnershipValue: "Los extranjeros pueden ser dueños a su nombre; consultá al escribano por este terreno",
  foreignerBoxTitleStatusLabel: "Estado del título",
  foreignerBoxTitleStatusValue: "Verificar en el Registro Público",
  foreignerBoxCostsLabel: "Costos de cierre",
  foreignerBoxCostsValue: "Pedí al agente y al escribano el detalle por escrito antes de firmar",
  foreignerBoxNextStepLabel: "Siguiente paso",
  foreignerBoxNextStepValue: "Contactá al vendedor y pedí una verificación de título.",
  replyInEnglish: "Tu consulta llega al agente de este aviso. Podés escribir en inglés.",
} as const;
...
export const esAboutPage = {
  principleInformation: "Información antes que avisos",
  principleInformationBody: "Un portal no debería ser solo un tablón. Publicamos medianas de precio por ciudad y por m², cuota estimada en cada propiedad en venta y tasación online gratuita, para que quien busca pueda comparar y no solo mirar.",
  principleDirect: "Contacto directo, sin peaje",
  principleDirectBody: "Las consultas van directo de quien busca a quien publica. No cobramos por lead, no revendemos contactos y no nos metemos en la negociación.",
  principleLocal: "Hecho para Paraguay",
  principleLocalBody: "Precios en guaraníes y dólares, barrios reales, WhatsApp como canal principal y programas de financiamiento locales — no un portal extranjero traducido.",
  principleNumbers: "Números que se pueden auditar",
  principleNumbersBody: "Nuestras estimaciones salen de avisos publicados y de condiciones vigentes de financiamiento, y decimos siempre sobre qué muestra están calculadas. Si el dato es flojo, lo decimos en vez de inventarlo.",
  home: "Inicio",
  kicker: "Quiénes somos",
  heading: "Buscar propiedad en Paraguay debería ser transparente",
  listings: "Propiedades publicadas",
  cities: "Zonas con inventario",
  agencies: "Inmobiliarias publicando",
  projects: "Proyectos en desarrollo",
  principlesHeading: "En qué creemos",
  revenueHeading: "Cómo ganamos plata",
  revenueIntro: "Preferimos decirlo de entrada, porque define cómo funciona todo lo demás. Buscar es gratis para quien busca y publicar es gratis para quien vende o alquila, incluidas las inmobiliarias. No cobramos comisión sobre las operaciones ni cobramos por consulta recibida.",
  revenueBody: "Nuestros ingresos vienen de la visibilidad preferente que contratan algunas inmobiliarias y desarrolladoras — avisos destacados, posiciones en la portada y en las páginas de ciudad. Eso significa que un aviso puede aparecer más arriba porque su publicante contrató destaque, y cuando pasa se muestra identificado como tal. Lo que nunca cambia por pagar es el precio, la superficie ni ningún otro dato de la propiedad.",
  limitsHeading: "Qué no hacemos",
  limitsBody: "No somos una inmobiliaria y no representamos a ninguna de las partes. No participamos de las negociaciones, no intervenimos en las señas ni en los contratos y no verificamos de forma independiente la titularidad de cada inmueble publicado. Antes de cualquier pago o firma, verificá la documentación con un escribano.",
  dataHeading: "De dónde salen los datos",
  dataBody: "Los avisos los cargan sus dueños, inmobiliarias y agentes desde el panel del portal. Las medianas de precio se calculan sobre los avisos publicados de cada ciudad y tipo de propiedad, y solo publicamos la cifra cuando la muestra alcanza un mínimo razonable. Las cuotas estimadas usan las condiciones de programas de financiamiento vigentes en Paraguay y son orientativas: la cuota real depende de la entidad, del plazo y de tu perfil crediticio.",
  ctaHeading: "¿Querés publicar tu propiedad?",
  ctaBody: "Cargala en minutos y llegá a quienes están buscando en tu zona.",
  publish: "Publicar gratis",
  contact: "Contactarnos",
  title: "Sobre nosotros",
  description: (brand: string) => `${brand} es el portal inmobiliario de Paraguay: buscar es gratis, publicar también, y cada aviso muestra precio de referencia de la zona y cuota estimada.`,
  intro: (brand: string) => `${brand} nació de una molestia concreta: buscar casa en Paraguay significa recorrer avisos repetidos, sin precio de referencia, sin saber si el número cierra con lo que uno puede pagar por mes. Armamos el portal que nos hubiera gustado usar.`,
} as const;
...
export const esContactPage = {
  ...
  whatsapp: "WhatsApp ",
  formChannel: "Formulario de contacto (respondemos por acá)",
  location: "Asunción, Paraguay",
  hours: "Lunes a viernes, 8:00 a 18:00",
  propertyHeading: "¿Consulta sobre una propiedad puntual?",
  propertyBody: "Las consultas sobre un aviso las responde quien lo publicó, no nosotros. Entrá a la propiedad y usá el formulario o el botón de WhatsApp que están en la ficha — así te contesta directamente el vendedor o la inmobiliaria.",
  browse: "Ver propiedades →",
  shortcutsHeading: "Atajos útiles",
  publish: "Publicar una propiedad",
  agencyAccount: "Cuenta para inmobiliarias",
  valuation: "Tasar mi propiedad gratis",
  faq: "Preguntas frecuentes",
  title: "Contacto",
  description: (brand: string) => `Escribinos por WhatsApp o dejanos tu consulta: publicación de propiedades, cuentas para inmobiliarias, proyectos y soporte de ${brand}.`,
} as const;

export const esAgentsPage = {
  home: "Inicio",
  kicker: "Empresas",
  heading: "Agentes inmobiliarios en Paraguay",
  ...
  empty: "Todavía no hay agentes con propiedades publicadas.",
  publish: "Publicar como agente",
  verified: "Verificado",
  portfolio: "Ver cartera →",
  directoryIntro: "¿Buscás la oficina y no la persona? Mirá el",
  directoryLink: "directorio de inmobiliarias",
  directoryOutro: ", con la cartera completa de cada una.",
  ctaHeading: "¿Sos agente inmobiliario?",
  ctaBody: "Creá tu perfil, publicá tu cartera y recibí las consultas directo en tu WhatsApp. Sin costo.",
  create: "Crear mi perfil",
  plans: "Ver planes",
  title: "Agentes inmobiliarios",
  metaTitle: "Agentes inmobiliarios en Paraguay",
  description: (brand: string) => `Agentes inmobiliarios que publican en ${brand}: su cartera activa, las zonas donde trabajan y su contacto directo por WhatsApp.`,
  independent: "Agente independiente",
  property: "propiedad",
  properties: "propiedades",
} as const;

export const esAgenciesPage = {
  home: "Inicio",
  kicker: "Directorio",
  heading: "Inmobiliarias y agentes en Paraguay",
  ...
  empty: "Todavía no hay inmobiliarias con cartera publicada en el directorio.",
  join: "Sumar mi inmobiliaria",
  verified: "Verificada",
  portfolio: "Ver cartera →",
  ctaHeading: "¿Tenés una inmobiliaria?",
  ctaBody: "Publicá tu cartera completa, obtené tu perfil verificado y recibí las consultas directo en tu WhatsApp.",
  joinCta: "Sumar mi inmobiliaria",
  plans: "Ver planes",
  title: "Directorio de inmobiliarias",
  metaTitle: "Directorio de inmobiliarias de Paraguay",
  description: (brand: string) => `Inmobiliarias y agentes que publican su cartera en ${brand}. Mirá sus propiedades activas y contactalos directo por WhatsApp.`,
  property: "propiedad",
  properties: "propiedades",
  agent: "agente",
  agents: "agentes",
...
export const esProjectsPage = {
  ...
  paymentsBody: "Muchos proyectos financian la etapa de construcción en cuotas, sin banco de por medio hasta la entrega.",
  choiceHeading: "Elegís la unidad",
  choiceBody: "Cuanto antes entrás, más opciones de piso, orientación y terminaciones quedan disponibles.",
  checksHeading: "Qué verificar",
  checksBody: "Trayectoria de la desarrolladora, permiso de construcción, fecha de entrega contractual y qué pasa si se atrasa. Pedí siempre el contrato antes de reservar.",
  home: "Inicio",
  kicker: "Obra nueva",
  heading: "Proyectos en desarrollo en Paraguay",
  ...
  empty: "Todavía no hay proyectos publicados en el portal.",
  publish: "Publicar mi proyecto",
  developersHeading: "Desarrolladoras",
  developersSubtitle: "Quiénes están construyendo los proyectos publicados.",
  adviceHeading: "Comprar en pozo: lo que conviene saber",
  ctaHeading: "¿Desarrollás proyectos?",
  ctaBody: "Publicá tu emprendimiento con todas sus unidades, plan de pagos y avance de obra.",
  publishCta: "Publicar mi proyecto",
  plans: "Ver planes",
  title: "Proyectos y obra nueva",
  metaTitle: "Proyectos y obra nueva en Paraguay",
  description: "Edificios, condominios, barrios cerrados y loteamientos en desarrollo en Paraguay: en pozo, en construcción y con entrega inmediata.",
  project: "proyecto",
  projects: "proyectos",
} as const;

export const esGuidesPage = {
  readingSuffix: " min de lectura",
  home: "Inicio",
  kicker: "Guías",
  heading: "Comprar, vender y alquilar en Paraguay, explicado",
  ...
  empty: "Todavía no publicamos ninguna guía. Mientras tanto, estas páginas responden lo más consultado:",
  howItWorks: "Cómo funciona",
  financing: "Financiamiento y cuotas",
  faq: "Preguntas frecuentes",
  ctaHeading: "¿Ya sabés cuánto vale tu propiedad?",
  ctaBody: "Tasación online gratuita, con los precios publicados de tu zona.",
  valuation: "Tasar gratis",
  marketData: "Ver datos del mercado",
  title: "Guías y notas",
...
export const esProjectPage = {
  ...
  home: "Inicio",
  projects: "Proyectos",
  imagesSoon: "Imágenes próximamente",
  unitsSuffix: " unidades disponibles",
  sale: "Venta",
  from: "desde ",
  aboutHeading: "Sobre el proyecto",
  locationHeading: "Ubicación",
  unitsHeading: "Unidades disponibles",
  unit: "Unidad",
  bedrooms: "Hab.",
  bathrooms: "Baños",
  area: "Área",
  price: "Precio",
  status: "Estado",
  otherPrefix: "Otros proyectos de ",
  contactHeading: "¿Interesado en este proyecto?",
  contactBody: "Contactanos hoy para más información o para agendar una visita.",
  notFound: "Proyecto no encontrado",
  description: (name: string) => `${name}: proyecto inmobiliario en Paraguay.`,
  seller: (brand: string) => `Publicado en ${brand}`,
  developerFallback: "esta desarrolladora",
  inquiry: (brand: string, title: string, url: string) => `Hola, vi esta propiedad en ${brand} y me interesa: ${title}\n${url}`,
} as const;

export const esPublicAuth = {
  loginTitle: "Ingresá a tu panel",
  loginSubtitle: "Usá tu email y contraseña.",
  loginLocked: "Demasiados intentos. Esperá unos minutos antes de volver a intentar.",
  loginError: "Email o contraseña incorrectos.",
  emailLabel: "Email",
  passwordLabel: "Contraseña",
  loginSubmit: "Entrar",
  ...
  registerErrorPassword: "La contraseña necesita al menos 8 caracteres.",
  registerErrorAgencyName: "Escribí el nombre de la inmobiliaria.",
  registerErrorInvite: "Esa invitación ya no sirve: puede estar vencida o ya usada. Pedile a la inmobiliaria que te mande una nueva.",
  registerErrorThrottled: "Demasiados intentos desde esta conexión. Esperá unos minutos y volvé a probar.",
  registerErrorGeneric: "No pudimos crear la cuenta. Probá de nuevo.",
  registerTitle: "Creá tu cuenta",
  registerSubtitle: "Cargá tus propiedades vos mismo. Es gratis: revisamos cada aviso antes de publicarlo.",
  registerInviteNote: (agencyName: string, role: string) =>
    `${agencyName} te invitó a sumarte a su equipo como ${role}. Creá tu cuenta y tus avisos van a quedar dentro de esa inmobiliaria.`,
  teamRoleAdmin: "Responsable",
  teamRoleAgent: "Agente",
...
export const esParaInmobiliarias = {
  ...
  benefitProfileBody: "Tu página con logo, equipo de agentes y todos tus avisos activos — un enlace que podés compartir y que además posiciona en Google.",
  benefitData: "Datos reales del mercado",
  benefitDataBody: "Medianas de precio por ciudad y por m² calculadas sobre avisos publicados. Argumentos concretos para la próxima captación.",
  benefitPayment: "Cuota estimada en cada aviso",
  benefitPaymentBody: "Mostramos automáticamente la cuota mensual aproximada con financiamiento vigente. El comprador entiende de entrada si le cierra el número.",
  benefitTeam: "Cuentas para tu equipo",
  benefitTeamBody: "Cada agente con su usuario y su perfil público, todo bajo la cuenta de la inmobiliaria. Vos ves la actividad de toda la oficina.",
  ...
  stepInquiriesBody: "Las consultas te llegan por WhatsApp y quedan registradas en tu panel, con la propiedad que las originó.",
  faqCost: "¿Cuánto cuesta publicar como inmobiliaria?",
  ...
  faqIndependentBody: "También podés publicar. Tenés perfil de agente propio, con tu foto, tu WhatsApp y tus avisos, sin necesidad de estar vinculado a una oficina.",
  home: "Inicio",
  kicker: "Para profesionales del sector",
  heading: "Tu cartera, frente a quien la está buscando",
  benefitsHeading: "Lo que incluye publicar con nosotros",
  benefitsIntro: "Todo esto entra en el plan gratuito. Sin límite de avisos, sin costo por consulta.",
  stepsHeading: "Cómo empezás",
  stepsIntro: "De crear la cuenta a tener la cartera publicada, normalmente el mismo día.",
  faqHeading: "Preguntas de inmobiliarias",
  contactHeading: "Hablemos de tu cartera",
  contactIntro: "Dejanos tus datos y te escribimos por WhatsApp para activar tu cuenta y ayudarte con la primera carga.",
  ...
  ctaHeading: "Empezá hoy, sin costo",
  ctaBody: "Creá tu cuenta, cargá tu primera propiedad y mirá cuántas consultas llegan.",
  intro: (brand: string) => `Publicá todas tus propiedades en ${brand}, recibí las consultas directo en tu WhatsApp y mostrá tu inmobiliaria en el directorio del portal. Empezar es gratis y no pedimos tarjeta.`,
  listings: "Propiedades publicadas",
  cities: "Zonas con inventario activo",
  agencies: "Inmobiliarias publicando",
  zeroCost: "Gs. 0",
  leadCost: "Costo por consulta recibida",
