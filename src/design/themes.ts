 ...
 *
 * The two marketplace doors have no entry: `inmobiliaria.com.py` and
 * `realestateinparaguay.com` run the EDITORIAL base — deep green, gold,
 * Cormorant over Jost, zero radius — since 2026-09-11
 * (`docs/prompts/premium-editorial.md`). The per-door "Nórdico" and "Petrol"
 * token sets they carried between 2026-09-04 and that date are deleted, not
 * disabled: the Premium Editorial home is designed on the base values, and a
 * second palette under it would be a divergence nobody asked for.
 */
